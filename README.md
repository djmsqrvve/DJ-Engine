...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-539-brightgreen?style=flat-square" alt="539 tests">
...
- **Helix data integration** -- consumes 2,868 MMORPG entities from the Helix standardization pipeline via typed TOML registries
- **539 tests, zero warnings** -- CI-enforced quality across the full workspace
